export const es_translations = {
    ...
    "requestGameReferral": "Introduce el nombre del juego",
    ...
    "giveGamesReferral": "A continuación pega los enlaces de referidos de aplicaciones",
    "giveDeviceReferral": "A continuación escribe tu nombre de usuario de Meta",
    "addedDeviceReferral": "Referido de visor del usuario {{userName}} ha sido añadido",
    "alreadyAddedDeviceReferral": "Usuario ya agregado",
    "wrongFormat": "Formato incorrecto",
    "addedGamesReferral": "Se detectaron {{games}} juegos\n\nEl proceso de agregar cada juego tarda un poco y es un proceso indirecto.\n\nPuede user el bot normalmente",
    "noFoundGames": "No se detectaron juegos en los enlaces",
    "button": {
        "give": "Dar",
        "request": "Pedir",
        "info": "Información",
